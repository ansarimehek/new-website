      ...
      <>
        ...
        <Carousel>
          <Carousel.Item interval={1000}>
            <img src={Banner1} height={850} width={1415} />
            <Carousel.Caption>
              {/* <h3></h3>
          ...
          <Carousel.Item interval={500}>
            <img src={Banner2} height={750} width={1415} className="my-5" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            ...
            <img src={Banner3} height={850} width={1415} className="my-5" />
            <Carousel.Caption>
